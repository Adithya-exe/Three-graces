...
I have done this project by taking Anderson Mancini's(github id : https://github.com/ektogamat) project on three graces as reference
...
--You would need to import the gltf file locally and run the files on live server for experiencing full functionality of the project
